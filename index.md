...
venue: "EI"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Darwin Room, Norwich"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Tony, Nicolas, Alice"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
